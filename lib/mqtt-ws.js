...
var Bridge = module.exports = function Bridge(options) {
    ...
    this.wss = new WebSocketServer(this.options.websocket);
    ...
    this.wss.on('connection', function(ws, req) {
        ...
        console.log('ws.connectString',ws.connectString)
...
Bridge.prototype.connectMqtt = function(options) {
    console.log(options)
    // Create our client
    var mqttClient = mqtt.connect(`mqtt://${this.options.mqtt.host}:${this.options.mqtt.port}`,options);
